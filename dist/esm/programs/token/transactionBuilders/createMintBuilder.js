...
import { createAccountBuilder } from "../../system";
import { initializeMintBuilder } from "./..";
import { TransactionBuilder } from "../../../shared";
export const createMintBuilder = (params) => {
    const { lamports, decimals, mint, payer, mintAuthority, freezeAuthority, tokenProgram = TOKEN_PROGRAM_ID, createAccountInstructionKey = 'createAccount', initializeMintInstructionKey = 'initializeMint', } = params;
